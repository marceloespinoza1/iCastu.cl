...
if (!class_exists('ElfsightContactFormPlugin')) {
    class ElfsightContactFormPlugin {
        private $name;
        private $slug;
        private $version;
        private $textDomain;
        ...
        public function __construct($config) {
            ...
            $this->update = new ElfsightContactFormPluginUpdate($this->updateUrl, $this->version, $this->pluginSlug, $this->purchaseCode);
            $this->widgetsApi = new ElfsightContactFormWidgetsApi($this->slug, $this->pluginFile, $this->textDomain);
            $this->admin = new ElfsightContactFormPluginAdmin($config, $this->widgetsApi);
            $this->widget = new ElfsightContactFormWidget($config, $this->widgetsApi);
            $this->vcElement = new ElfsightContactFormVCElement($config, $this->widgetsApi);
