...
namespace ElfsightContactFormApi\Core;
...
//        });
    ...
    public function initDebug($debug_mode) {
        if (class_exists('\ElfsightContactFormApi\Debug')) {
            return new \ElfsightContactFormApi\Debug($this, $debug_mode);
        } else {
            return new \ElfsightContactFormApi\Core\Debug($this, $debug_mode);
        }
    }

    public function initOptions($config) {
        if (class_exists('\ElfsightContactFormApi\Options')) {
            return new \ElfsightContactFormApi\Options($this->Helper, $config);
        } else {
            return new \ElfsightContactFormApi\Core\Options($this->Helper, $config);
        }
    }
