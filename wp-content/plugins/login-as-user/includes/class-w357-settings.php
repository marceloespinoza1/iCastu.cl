	...
	public function settings_init() 
	{
		...
		add_settings_field( 
			...
			[
				...
				'desc' => __('In order to update commercial Web357 plugins, you have to enter your License key. The key can be found in your account details at web357.com.', 'login-as-user')
			]
		);
	}
}