...
class Jobsearch_Login_Registration_Template
{
    ...
    public function __construct()
    {
        ...
        add_action('wp_ajax_jobsearch_userreg_form_after_nonce', array($this, 'reg_form_add_nonce'));
        add_action('wp_ajax_nopriv_jobsearch_userreg_form_after_nonce', array($this, 'reg_form_add_nonce'));
    }
        ...
        <div class="login-form-<?php echo absint($rand_numb) ?>">
            ...
            <form id="login-form-<?php echo absint($rand_numb) ?>" action="<?php echo home_url('/'); ?>" method="post">
                ...
                <div class="jobsearch-user-form">
                    ...
                    ?>
                    <?php do_action('jobsearch_after_regform_html_action', 'login-security'); ?>
        ...
        <div class="jobsearch-reset-password reset-password-<?php echo absint($rand_numb) ?>" style="display:none;">
            ...
            <form id="reset-password-form-<?php echo absint($rand_numb) ?>" action="<?php echo home_url('/'); ?>"
                ...
                <div class="jobsearch-user-form">
                    ...
                    //echo wp_kses($secur_field, $allow_args);
                    ?>
                    <?php do_action('jobsearch_after_regform_html_action', 'password-security'); ?>
    ...
    public function reg_form_add_nonce()
    {
        $allow_args = array(
            'input' => array(
                'name' => array(),
