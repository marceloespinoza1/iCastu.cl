                ...
                var api_scrapper = {
                    ...
                    readStateFile: function (country_code, selector) {
                        ...
                        if (jobsearch_is_admin == '' || ajax_flag == true) {
                            ...
                            jQuery('#jobsearch-gdapilocs-statecon').append('<select placeholder="<?php echo esc_html__("Select State", "wp-jobsearch") ?>"  class="states" id="stateId" name="<?php echo $state_param_name; ?>"><option value=""><?php echo esc_html__("Select State", "wp-jobsearch") ?></option></select>');
