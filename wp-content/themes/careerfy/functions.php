...
add_action( 'template_redirect', 'redirect_if_user_is_logged_in' );
 
function redirect_if_user_is_logged_in() {
 
	if ( is_page('777') &&  is_user_logged_in() ) { 
 
		wp_redirect( 'http://119.8.154.220/icastu.cl/actores'); 
 		exit();
