                ...
                if (!empty($employer_social_mlinks) || ($emp_alow_fb_smm == 'on' || $emp_alow_twt_smm == 'on' || $emp_alow_gplus_smm == 'on' || $emp_alow_linkd_smm == 'on' || $emp_alow_dribbb_smm == 'on')) {
                    ...
                    <ul class="careerfy-employerfour-top-social">
                        ...
                        if ($user_dribbble_url != '' && $emp_alow_dribbb_smm == 'on') {
                            ?>
                            <li><a href="<?php echo esc_url($user_dribbble_url) ?>" target="_blank" data-original-title="dribbble" class="fa fa-dribbble"></a></li>
                            <?php
                        }
                            ...
                            if (isset($employer_social_mlinks['title']) && is_array($employer_social_mlinks['title'])) {
                                ...
                                foreach ($employer_social_mlinks['title'] as $field_title_val) {
                                    ...
                                    if ($field_title_val != '' && $emp_dynm_social != '') {
                                        ?>
                                        <li><a href="<?php echo esc_url($emp_dynm_social) ?>" target="_blank" <?php echo ($field_icon_styles != '' ? 'style="' . $field_icon_styles . '"' : '') ?> class="<?php echo ($field_icon) ?>"></a></li>
                                        <?php
                                    }
                                    $field_counter++;
                                }
                                                ...
                                                <div class="careerfy-joblisting-plain-left">
                                                    ...
                                                    <ul>
                                                        ...
                                                        if (isset($job_max_salary) && !empty($job_max_salary)) {
                                                            ?>
                                                            <li><i class="careerfy-icon careerfy-money-line"></i> <?php echo ($job_max_salary); ?></li>
                                                            <?php
                                                        }
                                                        ?>
