...
<div class="employer-two-cover"<?php echo ($employer_cover_image_src_style_str); ?>>
    <span class="careerfy-light-transparent" style="background: <?php echo !empty($subheader_bg_color) ? $subheader_bg_color : 'rgb(48, 56, 68, 0.50)' ?>"></span>
</div>
                        ...
                        <div class="careerfy-right">
                            ...
                            if ($reviews_switch == 'on') {
                                if (is_user_logged_in()) {
                                    ...
                                    ?>
                                    <a href="javascript:void(0);" data-target="add_review_form_sec" class="careerfy-employer-detail2-toparea-btn jobsearch-go-to-review-form" data-post_id="<?php echo ($employer_id) ?>"><i class="careerfy-icon careerfy-add"></i> <?php esc_html_e('Agrega una reseña', 'careerfy') ?></a>
                                    <?php
                                } else {
                                    ?>
                                    <a href="javascript:void(0);" class="careerfy-employer-detail2-toparea-btn jobsearch-open-signin-tab"><i class="careerfy-icon careerfy-add"></i> <?php esc_html_e('Agrega una reseña', 'careerfy') ?></a>
                                    <?php
                                }
                            }
                            ?>
                            ...
                            if (!empty($employer_social_mlinks) || ($emp_alow_fb_smm == 'on' || $emp_alow_twt_smm == 'on' || $emp_alow_gplus_smm == 'on' || $emp_alow_linkd_smm == 'on' || $emp_alow_dribbb_smm == 'on')) {
                                ...
                                <ul class="widget_your_info_social">
                                    ...
                                    if ($user_facebook_url != '' && $emp_alow_fb_smm == 'on') {
                                        ?>
                                        <li><a href="<?php echo esc_url($user_facebook_url) ?>" target="_blank" data-original-title="facebook" class="fa fa-facebook"></a></li>
                                        <?php
                                    }
                                    if ($user_twitter_url != '' && $emp_alow_twt_smm == 'on') {
                                        ?>
                                        <li><a href="<?php echo esc_url($user_twitter_url) ?>" target="_blank" data-original-title="twitter" class="fa fa-twitter"></a></li>
                                        <?php
                                    }
                                    if ($user_linkedin_url != '' && $emp_alow_linkd_smm == 'on') {
                                        ?>
                                        <li><a href="<?php echo esc_url($user_linkedin_url) ?>" target="_blank" data-original-title="linkedin" class="fa fa-linkedin"></a></li>
                                        <?php
                                    }
                                    if ($user_google_plus_url != '' && $emp_alow_gplus_smm == 'on') {
                                        ?>
                                        <li><a href="<?php echo esc_url($user_google_plus_url) ?>" target="_blank" data-original-title="google-plus" class="fa fa-google-plus"></a></li>
                                        <?php
                                    }
                                        ...
                                        if (isset($employer_social_mlinks['title']) && is_array($employer_social_mlinks['title'])) {
                                            ...
                                            foreach ($employer_social_mlinks['title'] as $field_title_val) {
                                                ...
                                                if ($field_title_val != '' && $emp_dynm_social != '') {
                                                    ?>
                                                    <li><a href="<?php echo esc_url($emp_dynm_social) ?>" <?php echo ($field_icon_styles != '' ? 'style="' . $field_icon_styles . '"' : '') ?> target="_blank" class="<?php echo ($field_icon) ?>"></a></li>
                                                    <?php
                                                }
                                                $field_counter++;
                                            }
