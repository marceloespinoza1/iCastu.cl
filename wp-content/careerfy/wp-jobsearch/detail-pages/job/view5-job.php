                                ...
                                <div class="careerfy-jobdetail-style5-content">
                                    ...
                                    <div class="careerfy-jobdetail-style5-content-list">
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                <?php if ($jobsearch_job_min_salary != '' && $jobsearch_job_max_salary != '') { ?>
                                                    <i class="jobsearch-color fa fa-money"></i><?php echo $jobsearch_job_min_salary ?>-<?php echo $jobsearch_job_max_salary . " /" . $salary_type ?>
                                                <?php } ?>
                                        ...
                                        if ($job_shortlistbtn_switch == 'on') {
                                            ...
                                            $before_label = esc_html__('Agregar a la lista', 'careerfy');
                                            $after_label = esc_html__('Guardado', 'careerfy');
                                        ...
                                        <div class="jobsearch-about-company-style5">
                                            ...
                                            <div class="jobsearch-about-company-content-style5">
                                                <?php if (!empty($user_obj->display_name)) { ?>
                                                    <span><small><?php echo esc_html__('Name: ', 'wp-jobsearch') ?></small><?php echo($user_obj->display_name); ?></span>
                                                <?php } ?>
                                                <?php if (!empty($user_phone)) { ?>
                                                    <span><small><?php echo esc_html__('Phone:', 'wp-jobsearch') ?></small> <a
                                                                href="tel:<?php echo($user_phone); ?>"><?php echo($user_phone); ?></a> </span>
                                                <?php } ?>
                                                <?php if (isset($user_obj->user_email)) { ?>
                                                    <span><small><?php echo esc_html__('Email:', 'wp-jobsearch') ?></small> <a
                                                                href="mailto: <?php echo($user_obj->user_email) ?>"><?php echo($user_obj->user_email) ?></a> </span>
                                                <?php } ?>
                                                <?php if (isset($user_obj->user_url)) { ?>
                                                    <span><small><?php echo esc_html__('Website:', 'wp-jobsearch') ?></small> <a
