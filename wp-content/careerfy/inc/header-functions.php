...
function careerfy_responsive_logo($link_class = 'jobsearch-responsive-logo')
{
    ...
    $careerfy_logo = isset($careerfy_framework_options[$resp_logo_key]['url']) && $careerfy_framework_options[$resp_logo_key]['url'] != '' ? $careerfy_framework_options[$resp_logo_key]['url'] : $logo_default_val;
                ...
                if ($top_strip == 'on') { ?>
                    <div class="jobsearch-top-strip">
                        <ul class="jobsearch-strip-info">
                            ...
                            if ($top_location != '') {
                                ?>
                                <li><i class="careerfy-icon careerfy-pin-line"></i> <?php echo($top_location) ?>
                                </li>
                                <?php
                            }
                            if ($top_phone != '') {
                                ?>
                                <li>
                                    <i class="careerfy-icon careerfy-technology"></i> <a href="tel:<?php echo ($top_phone) ?>"><?php printf(esc_html__('%s', 'careerfy'), $top_phone) ?></a>
                                </li>
                                <?php
                            }
                            if ($top_email != '') { ?>
    ...
    function careerfy_top_menu_login_links($links, $register_link_view = true)
    {
        ...
        if ($header_style == 'style2') {
            ...
            <li><a href="javascript:void(0);" class="jobsearch-open-signin-tab"><i
                            class="careerfy-icon careerfy-login"></i> <?php esc_html_e('Ingresar', 'careerfy') ?></a>
            </li>
            <?php
            ...
            <li class="active jobsearch-open-signin-tab"><a href="javascript:void(0);"><i
                            class="careerfy-icon careerfy-user"></i> <?php esc_html_e('Ingresar', 'careerfy') ?></a>
            </li>
            <?php
            $links = ob_get_clean();
        } else if ($header_style == 'style5') {
            ...
            <li class="careerfy-color"><a href="javascript:void(0);" class="jobsearch-open-signin-tab"><i
                            class="careerfy-icon careerfy-logout"></i> <?php echo esc_html__('Ingresar', 'careerfy'); ?>
                </a></li>
            <?php
            if ($register_link_view === true) {
                ?>
